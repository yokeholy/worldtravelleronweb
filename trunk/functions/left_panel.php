...
<div class="leftpanel_box" style="height:340px; top:50px; position:relative;">
	<p class="leftpanel_text"><a href="/main.php"><img src="/images/leftpanel_button_home.png" width="200" height="30"></a><br>
	...
	<table width="80%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td align="left"><p class="leftpanel_text"><strong>Coin: <span style="color:#920"><?php echo $UserInfo['Coin']?></span></strong></p></td>
			<td align="left"><p class="leftpanel_text"><strong>Gold: <span style="color:#920"><?php echo $UserInfo['Gold']?></span></strong></p></td>
		</tr>
		<tr>
	...
	<p class="leftpanel_text">&nbsp;</p>
</div>

<div class="leftpanel_box" style="height:35px; top:70px; position:relative;">
<p class="leftpanel_text"><strong>My Current Location<br>
